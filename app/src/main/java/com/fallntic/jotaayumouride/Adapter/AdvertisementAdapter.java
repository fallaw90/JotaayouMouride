...
public class AdvertisementAdapter extends RecyclerView.Adapter<AdvertisementAdapter.DahiraViewHolder> {
    ...
    public AdvertisementAdapter(Context context, List<PubImage> listPub) {
